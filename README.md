...
**25 ready-to-use workflows for AI Visibility, content production, and agency operations — installable as a Claude Code plugin.**
...
- `surge-author-setup` — create an author and synthesize their writing voice from samples
- `surge-brand-setup` — set the project brand profile, image colors, and brand mentions
